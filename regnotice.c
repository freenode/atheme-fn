...
static void nick_reg_notice(void *vptr)
{
	...
	myuser_notice(nicksvs.nick, mu, "Knowledge Base (http://freenode.net/kb/all). Should you need more");
...
static void chan_reg_notice(void *vptr)
{
	...
	else
	{
		...
		command_success_nodata(si, "http://freenode.net/policies");
	}
